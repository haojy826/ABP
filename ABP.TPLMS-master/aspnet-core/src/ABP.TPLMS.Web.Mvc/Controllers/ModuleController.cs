...
namespace ABP.TPLMS.Web.Controllers
{
    ...
    public class ModuleController : TPLMSControllerBase
    {
        ...
        public ModuleController(IModuleAppService moduleAppService)//依赖注入
        {
        ...
        public IActionResult Index()
        {
            ...
            var config = new MapperConfiguration(cfg => cfg.CreateMap<ModuleDto, CreateUpdateModuleDto>());//创建映射规则
