...
namespace ABP.TPLMS.Web.Controllers
{
    ...
    public class OrgsController : TPLMSControllerBase
    {
        ...
        public OrgsController(IOrgAppService orgAppService)//依赖注入
        {
        ...
        public string List()
        {
            ...
            var orgListJson = ABP.TPLMS.Helpers.json.Instance.Serialize(orgList);
            ...
            foreach (var orgJson in orgListArray)
            {
                ...
                //当是顶级组织时，_parentId为空，必须移除_parentId属性，否则treegrid不会显示。多么重要的一句，我竟然没看见。。。。。。
        ...
        [DontWrapResult]
        [HttpGet]
        public JsonResult GetJsonTree()//为了在选项中展开列表时使用，列表是树形列表
        {
